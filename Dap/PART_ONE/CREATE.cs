                ...
                // Заповнення таблиць
                {
                    ...
                    try
                    {
                        command.CommandText =
                           ...
                           "            (N'Шевчук Тетяна Борисівна',            '05.24.1977', 'fmikituk@pickuplanet.com',           10000,  10065)," +
                           "            (N'Броварчук Данило Олексійович',       '07.02.1985', 'vitalij.antonen@kenvanharen.com',    10000,  10065)," +
                           "            (N'Середа Ілля Євгенович',              '08.18.1989', 'anton.dmitrenko@bengkoan.ninja',     10000,  10065)," +
                           "            (N'Васильчук Віталій Федорович',        '11.11.1997', 'zaharcuk.baleri@freeallapp.com',     10000,  10065)," +
                           "            (N'Василенко Олена Євгенівна',          '08.28.1972', 'vira.kramarcuk@54.mk',               10000,  10065)," +
                           "            (N'Таращук Наташа Андріївна',           '02.13.1965', 'artur98@24hinbox.com',               10000,  10065)," +
                           "            (N'Ніна Шевчук Борисівна',              '01.01.1983', 'aponomarenko@mailsupply.net',        10000,  10065)," +
                           "            (N'Васильчук Bіктор Олександрович',     '05.14.1997', 'brovarcuk.roman@iniprm.com',         10000,  10065)," +
                           "            (N'Крамарчук Раїса Янівна',             '02.17.1964', 'valentin.brovar@onlinecmail.com',    10000,  10065)," +
                           "            (N'Мірошниченко Андрій Євгенійович',    '01.21.1978', 'olena03@yt-google.com',              10000,  10065)," +
                           "            (N'Броварчук Данил Михайлович',         '08.07.1972', 'melnicenko.aros@dailyladylog.com',   10000,  10065)," +
                           "            (N'Боднаренко Віра Сергіївна',          '10.09.1996', 'margarita61@crossfitcoastal.com',    10000,  10065)," +
                           "            (N'Кравчук Bалерій Тарасович',          '12.25.2002', 'xzaharcuk@kurma-rasulullah.store',   10000,  10065)," +
                           "            (N'Гнатюк Валерія Євгенівна',           '09.16.2001', 'sevcuk.oksana@email-temp.com',       10000,  10065)," +
                           "            (N'Петренко Марина Олександрівна',      '01.28.1984', 'sinkarenko.lev@hongsaitu.com',       10000,  10065)," +
                           "            (N'Задорожна Марія Олександрівна',      '05.20.2001', 'exempl25@gmail.com', 10015,          10048);";
                        /*
                        command.CommandText =
